...
***********************************************************/	
	...
	//Set Upload directory    
		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/social-network-website/assets/images/profile_pics';
	//Set File name	
...
<div class="main_column column">
  ...
  <div id="CroppingContainer"
    style="width:800px; max-height:600px; background-color:#FFF; margin-left: -200px; position:relative; overflow:hidden; border:2px #666 solid; z-index:200; padding-bottom:0px;">
    ...
    <div id="CropImageForm2" style="width:100px; height:30px; float:left; margin:10px 0px 0px 40px;">
      <form action="upload.php" method="POST" onsubmit="return cancelCrop();">
        ...
        <input type="submit" value="test button" name="testbtn">
      </form>
